...
window.renderTeacherLkpd = window.renderTeacherLkpd || function() { 
    return '<div>Loading LKPD...</div>'; 
};
...
function renderTeacherContent() {
    ...
    switch(state.teacherSubView) {
        ...
        case 'lkpd': // TAMBAHKAN CASE INI
            return renderTeacherLkpd();
        case 'rekap':
